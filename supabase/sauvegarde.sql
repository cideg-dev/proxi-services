...
CREATE TABLE public.commercant_profiles (
  user_id integer NOT NULL,
  ...
  CONSTRAINT commercant_profiles_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id)
);
CREATE TABLE public.demandes (
  ...
  CONSTRAINT demandes_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.users(id),
  CONSTRAINT demandes_artisan_id_fkey FOREIGN KEY (artisan_id) REFERENCES public.users(id)
);
CREATE TABLE public.favorites (
  ...
  CONSTRAINT favorites_favorite_artisan_id_fkey FOREIGN KEY (favorite_artisan_id) REFERENCES public.users(id)
);
...
CREATE TABLE public.portfolio_items (
  ...
  CONSTRAINT portfolio_items_artisan_id_fkey FOREIGN KEY (artisan_id) REFERENCES public.users(id)
);
CREATE TABLE public.reports (
  ...
  CONSTRAINT reports_reported_review_id_fkey FOREIGN KEY (reported_review_id) REFERENCES public.reviews(id),
  CONSTRAINT reports_reported_portfolio_item_id_fkey FOREIGN KEY (reported_portfolio_item_id) REFERENCES public.portfolio_items(id),
  CONSTRAINT reports_resolved_by_admin_id_fkey FOREIGN KEY (resolved_by_admin_id) REFERENCES public.users(id)
);
CREATE TABLE public.reviews (
  ...
  CONSTRAINT reviews_artisan_id_fkey FOREIGN KEY (artisan_id) REFERENCES public.users(id),
...
CREATE TABLE public.services (
  ...
  CONSTRAINT services_artisan_id_fkey FOREIGN KEY (artisan_id) REFERENCES public.users(id)
);
